...
- Slot structure (sub_1012E360): 28 `DragnDropSlot` children, 28x28. Grid is **6 columns × 4 rows** (outer `v34<6` = X, inner `i<4` = Y, `v1+=6` walks down a column). Index `row*6+col` so pickups fill **left-to-right** on the wide 1024x512 art. Origin (44, 119), pitch 37. Extra 24..27 at (82,118), (82,81), (343,118), (343,81). Frame is not proportional. LMB/RMB Use-Drop menu as before.
