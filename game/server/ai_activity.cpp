...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR( ACT_WALK_UNARMED );
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_TO_RAISED );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_RAISED );
	ADD_ACTIVITY_TO_SR( ACT_VM_RAISED_TO_IDLE );
...
//===========================
	...
	ADD_ACTIVITY_TO_SR ( ACT_VM_RECOIL1_SILENCED );
	ADD_ACTIVITY_TO_SR ( ACT_VM_RECOIL2_SILENCED );
	ADD_ACTIVITY_TO_SR ( ACT_VM_RECOIL3_SILENCED );
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_PRONE_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_TO_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_TO_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_MP_PRONE_TO_STAND );
	ADD_ACTIVITY_TO_SR( ACT_MP_PRONE_TO_CROUCH );
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_PRONE_CRAWL );
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_PRONE_PRIMARYFIRE );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_PRONE_PRIMARYFIRE_DEPLOYED );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_PRONE_SECONDARYFIRE );
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_PRONE_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_PRONE_END );
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_PRONE_CRAWL_PRIMARY );
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_PRONE_CRAWL_SECONDARY );
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_PRONE_CRAWL_MELEE );
	...
	ADD_ACTIVITY_TO_SR( ACT_KICK );
	ADD_ACTIVITY_TO_SR( ACT_KICK_CROUCHED );
}
