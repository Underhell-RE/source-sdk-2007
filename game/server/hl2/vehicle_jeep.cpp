...
void CPropJeep::FireCannon( void )
{
	...
	// Underhell's mounted gun fires every 0.1 seconds. It keeps the jeep
	// weapon's damage/ammo path; only the tracer/impact branch is changed by
	// m_bEnableMountedGun. Replacing its ammo with AR2 and sending a second
	// full-length tracer created the broken double, through-wall beam.
