...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY( ACT_WALK_UNARMED );
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_TO_RAISED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_RAISED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RAISED_TO_IDLE );
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY ( ACT_VM_RECOIL1_SILENCED );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_RECOIL2_SILENCED );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_RECOIL3_SILENCED );
...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_MP_STAND_TO_PRONE );
	REGISTER_SHARED_ACTIVITY ( ACT_MP_CROUCH_TO_PRONE );
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_TO_STAND );
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_TO_CROUCH );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_CRAWL );
	...
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_PRONE_PRIMARYFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_PRONE_PRIMARYFIRE_DEPLOYED );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_PRONE_SECONDARYFIRE );
	...
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_PRONE_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_PRONE_END );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_CRAWL_PRIMARY );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_CRAWL_SECONDARY );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PRONE_CRAWL_MELEE );
